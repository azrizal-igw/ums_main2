...
<?php echo $this->Form->create('UserdetailsTraining');?>
	<fieldset>
		<legend><?php echo __('Edit Userdetails Training'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserdetailsTraining.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UserdetailsTraining.id'))); ?></li>
