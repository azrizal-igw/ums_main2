	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">
										<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ReadingsPest.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ReadingsPest.id'))); ?></li>
	...
	<div id="page-content" class="span9">
		...
		<div class="readingsPests form">
			...
			<?php echo $this->Form->create('ReadingsPest', array('inputDefaults' => array('label' => false), 'class' => 'form form-horizontal')); ?>
				<fieldset>
					<h2><?php echo __('Edit Readings Pest'); ?></h2>
