...
<html lang="en">
  <head>
    ...
    <meta name="description" content="UMS Web">
...
!-->
  ...
  <body class="preview" id="top" data-spy="scroll" data-target=".subnav" data-offset="80">
    <script src="../js/bsa.js"></script>
				...
				<?php echo $this->element('menu/menu_1'.$this->Session->read('Auth.User.group_id')); ?>
...
// var CONF_PATH = {
//   < ?php 
//   $pth = Configure::read('CONF_PATH');
//   foreach($pth as $i=>$d ){?>
//   '< ?php echo $i ;?>' : '< ?php echo $d ;?>',
//   < ?php } ?>
// }
</script>
