	...
	<li><a href="#" class="drop">Training</a><!-- Begin 4 columns Item -->
        ...
        <div class="dropdown_4columns"><!-- Begin 4 columns container -->
            ...
            <div class="col_1">
                ...
                <h3>Module</h3>
                <ul>
                   <li><?php echo $this->Html->link(__('List Module'), array('controller' => 'Modules','action' => 'add')); ?></li>
					<li><?php echo $this->Html->link(__('Add Module'), array('controller' => 'Modules', 'action' => 'index')); ?> </li>
                </ul>   
