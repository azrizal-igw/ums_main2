...
<div id="page-container" class="row-fluid">
	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">			
						<li><?php echo $this->Html->link(__('Edit Chemical'), array('action' => 'edit', $chemical['Chemical']['id']), array('class' => '')); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Chemical'), array('action' => 'delete', $chemical['Chemical']['id']), array('class' => ''), __('Are you sure you want to delete # %s?', $chemical['Chemical']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Chemicals'), array('action' => 'index'), array('class' => '')); ?> </li>
		<li><?php echo $this->Html->link(__('New Chemical'), array('action' => 'add'), array('class' => '')); ?> </li>
	...
	<div id="page-content" class="span9">
		...
		<th><?php echo __('Created'); ?></th>
							...
							<?php
								$i = 0;
								foreach ($chemical['Reading'] as $reading): ?>
		<tr>
