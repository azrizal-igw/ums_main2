<div class="threegs view">
<h2><?php  echo __('Threeg');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($threeg['Threeg']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Bm'); ?></dt>
		<dd>
			<?php echo h($threeg['Threeg']['bm']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Eng'); ?></dt>
		<dd>
			<?php echo h($threeg['Threeg']['eng']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Threeg'), array('action' => 'edit', $threeg['Threeg']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Threeg'), array('action' => 'delete', $threeg['Threeg']['id']), null, __('Are you sure you want to delete # %s?', $threeg['Threeg']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Threegs'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Threeg'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($threeg['Userdetail'])):?>
	...
	<?php
		$i = 0;
		foreach ($threeg['Userdetail'] as $userdetail): ?>
		<tr>
