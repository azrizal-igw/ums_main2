<div class="fixlines view">
<h2><?php  echo __('Fixline');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($fixline['Fixline']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Bm'); ?></dt>
		<dd>
			<?php echo h($fixline['Fixline']['bm']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Eng'); ?></dt>
		<dd>
			<?php echo h($fixline['Fixline']['eng']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Fixline'), array('action' => 'edit', $fixline['Fixline']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Fixline'), array('action' => 'delete', $fixline['Fixline']['id']), null, __('Are you sure you want to delete # %s?', $fixline['Fixline']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Fixlines'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Fixline'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($fixline['Userdetail'])):?>
	...
	<?php
		$i = 0;
		foreach ($fixline['Userdetail'] as $userdetail): ?>
		<tr>
