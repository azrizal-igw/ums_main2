<div class="bbands view">
<h2><?php  echo __('Bband');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($bband['Bband']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Bm'); ?></dt>
		<dd>
			<?php echo h($bband['Bband']['bm']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Eng'); ?></dt>
		<dd>
			<?php echo h($bband['Bband']['eng']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Bband'), array('action' => 'edit', $bband['Bband']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Bband'), array('action' => 'delete', $bband['Bband']['id']), null, __('Are you sure you want to delete # %s?', $bband['Bband']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Bbands'), array('action' => 'index')); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($bband['Userdetail'] as $userdetail): ?>
		<tr>
