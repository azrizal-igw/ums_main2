...
<div class="acctransactions index">
	...
	<?php } else if (substr($thismonth_transmonth,0,6) < date('Ym') ){?>
		<?php echo $this->Html->link(__('Close this account'), array('action' => 'closeaccount', substr($thismonth_transmonth,0,6)), null, __('Are you sure you want to closed this account ?')); ?>&nbsp;&nbsp;<?php }?>
	</h2>
	<br />
