...
<?php echo $this->Form->create('Acctransaction',array('id'=>'entryForm','alt'=>'add', 'type' => 'file'));?>
...
<table cellpadding="0" >
<tr><td><?php echo (isset($parent))?$parent['Acccode']['name']:"";?>:</td>
<td><?php echo $this->Form->input('acccode_id',array('label'=>false));?></td></tr>
...
<tr><td>Attachment<br>(If Any): </td><td><?php echo $this->Form->input('file',array('type' => 'file','label'=>false)); ?></td></tr>
</table>
