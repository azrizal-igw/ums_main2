<div class="ictknowledges view">
<h2><?php  echo __('Ictknowledge');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($ictknowledge['Ictknowledge']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Bm'); ?></dt>
		<dd>
			<?php echo h($ictknowledge['Ictknowledge']['bm']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Eng'); ?></dt>
		<dd>
			<?php echo h($ictknowledge['Ictknowledge']['eng']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Ictknowledge'), array('action' => 'edit', $ictknowledge['Ictknowledge']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Ictknowledge'), array('action' => 'delete', $ictknowledge['Ictknowledge']['id']), null, __('Are you sure you want to delete # %s?', $ictknowledge['Ictknowledge']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($ictknowledge['Userdetail'])):?>
	...
	<?php
		$i = 0;
		foreach ($ictknowledge['Userdetail'] as $userdetail): ?>
		<tr>
